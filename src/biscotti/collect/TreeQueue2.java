 ...
 */
public class TreeQueue2<E> extends SortedCollectionImpl<E> implements Queue<E> {

	private static final long serialVersionUID = 1L;

	private TreeQueue2(final Comparator<? super E> comparator) {
		super(comparator);
	}
	...
	public static <E> TreeQueue2<E> create(
	 ...
	 * {@link TreeQueue2#orderedBy(Comparator)}.
	 * 
	 * @author Zhenya Leonov
	 * @param <B>
	...
	public static final class Builder<B> {
		 ...
		 *         comparator.
		 */
		public <T extends B> TreeQueue2<T> create() {
			return new TreeQueue2<T>(comparator);
		}
		...
		public <T extends B> TreeQueue2<T> create(
			...
			checkNotNull(elements);
			final TreeQueue2<T> list = new TreeQueue2<T>(comparator);
	...
	@SuppressWarnings("unchecked")
	@Override
	public TreeQueue2<E> clone() {
		TreeQueue2<E> clone;
		try {
			clone = (TreeQueue2<E>) super.clone();
