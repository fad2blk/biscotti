...
import static collect.TreeQueue.Color.BLACK;
import static collect.TreeQueue.Color.RED;
...
public class TreeQueue<E> extends AbstractQueue<E> implements
	...
	/**
	 * Creates a new {@code TreeQueue2} that orders its elements according to
	 * their <i>natural ordering</i>.
	 *
	 * @return a new {@code TreeQueue2} that orders its elements according to
	 *         their <i>natural ordering</i>
	 */
	...
	/**
	 * Creates a new {@code TreeQueue2} that orders its elements according to the
	...
	/**
	 * Creates a new {@code TreeQueue2} containing the elements of the specified
	 ...
	 * @return a new {@code TreeQueue2} containing the elements of the specified
	 *         iterable
...
//	/**
//	 * Creates a {@code TreeQueue2} containing the specified initial elements
//	 * sorted according to their <i>natural ordering</i>.
//	 *
//	 * @param elements
//	 *            the initial elements to be placed in this queue
//	 * @return a {@code TreeQueue2} containing the specified initial elements
//	 *         sorted according to their <i>natural ordering</i>
//	 */
//	public static <E extends Comparable<? super E>> TreeQueue2<E> create(
//			final E... elements) {
//		checkNotNull(elements);
//		TreeQueue2<E> q = TreeQueue2.create();
...
//	}
	...
	/**
	 * Returns a shallow copy of this {@code TreeQueue2}. The elements themselves
	 * are not cloned.
	 *
