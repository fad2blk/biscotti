 ...
 * </tr>
 * <tr>
 * <td style="text-align:center;"><b>Skiplist</b><br>
 * (<i>expected</i>)</td>
 * <td style="text-align:center;"><b>Treelist</b><br>
 * (<i>worst-case</i>)</td>
 * </tr>
 * <tr>
 * <td>
...
public class Skiplist<E> extends AbstractCollection<E> implements
	...
	/**
	 * Returns a new builder configured to build {@code Skiplist} instances that
	 * use the specified comparator for ordering.
	 * 
	 * @param comparator
	 *            the specified comparator
	 * @return Returns a new builder configured to build {@code Skiplist}
