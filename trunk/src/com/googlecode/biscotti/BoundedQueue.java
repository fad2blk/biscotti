...
public interface BoundedQueue<E> extends Queue<E> {
	 ...
	 * queue from overflowing, returning {@code true} upon success or throwing
	 * an {@code IllegalStateException} if the element was rejected due to
	 ...
	 * to prevent the queue from overflowing, returning {@code true} upon
	 * success or throwing an {@code IllegalStateException} if not all the
